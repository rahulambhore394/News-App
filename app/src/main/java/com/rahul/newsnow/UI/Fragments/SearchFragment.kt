...
import com.rahul.newsnow.Utils.Constants.Companion.SEARCH_NEWS_TIME_DELAY
import com.rahul.newsnow.Utils.Resource
import com.rahul.newsnow.databinding.FragmentSearchBinding
            ...
            when(response){
                is Resource.Success<*> ->{
                    ...
                    response.date?.let { newsResponse ->
                        ...
                        isLastPage = newsViewModel.searchNewsPages == totalPages
                        if (isLastPage){
